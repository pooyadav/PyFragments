...
#JSON = grammar("""pair  => string : value
#value => array | object | number | string | boolean
#array    => [[] elements []] 
...
#boolean => "true" | "false"
#string  => \"[a-zA-Z][a-zA-Z_]*\"
#int     => [-+]?[0-9]+
#frac    => [.][0-9]*
#exp     => [e]int """, whitespace='\s*')


# PN's exact solution -- but does NOT work
